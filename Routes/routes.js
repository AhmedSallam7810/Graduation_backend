...
userApi.route("/:id").put(checkId, checkPassword, checkMail, updateUser);
userApi.route("/Forget_password").get().post(forgot);
userApi.route("/reset-password/:id/:token").get(GetReset).post(PostReset);
userApi.route("/login").post(checkToken, getSpecificUser);
